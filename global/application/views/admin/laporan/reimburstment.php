			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Generate Laporan Reimburstment Karyawan</li>
					</ol>
				</div>
			</div>
		</div><!-- /.container-fluid -->
	...
	<section class="content">
		...
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-md-12">
						<h3 class="card-title">Laporan Reimburstment Karyawan</h3>
					</div>
				</div>

			</div>
			<div class="card-body">
				<form action="<?php echo base_url() ?>admin/laporan_reimburstment_pdf" method="POST" enctype="multipart/form-data" formtarget="_blank" target="_blank">
					<div class="row">
						<div class="col-sm-6">
